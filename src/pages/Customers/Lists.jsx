...
import utmSource, { countries } from "../../utils/customers/cardData";

const CustomersLists = () => {
  const [isLargerThan1690] = useMediaQuery("(max-width: 1080px)");
  return (
    <Grid
      w={"100%"}
      gap={"22px"}
      templateColumns={isLargerThan1690 ? "1fr" : "1fr 1fr"}
    >
      <Card
